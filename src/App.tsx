  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-zinc-200 flex flex-col font-sans selection:bg-emerald-500/30 overflow-x-hidden">
      ...
      <div className="flex flex-1 overflow-hidden relative">
        ...
        {/* Sidebar */}
        <motion.div 
          className="fixed inset-y-0 left-0 z-40 md:relative md:z-auto pt-16 md:pt-0 w-[65vw] sm:w-[50vw] md:w-auto h-full bg-zinc-900 border-r border-zinc-800"
          initial={false}
          ...
          <div className="max-w-7xl mx-auto">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-8 gap-4">
              <div className="flex items-center gap-4">
                ...
                >
                  <Eye size={16} />
                  {showMonitoredOnly ? 'Ver Todas as Ofertas' : 'Ver Monitoramento'}
                </button>
              </div>
